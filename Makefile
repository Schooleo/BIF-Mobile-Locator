...
help:
	...
	@echo "  up           - Start CORE services (Server, Mongo)."
	...
	@$(ECHO_BLANK)
	@echo "SETUP COMMANDS:"
	@echo "  init-map      - Download Overture places + OSM data and compile OSRM"
	@echo "  init-city-map - Build city-level OSRM graph from LAT/LON in Vietnam"
	@echo "  init-brouter-cache - Build BRouter rd5 cache for Android"
	@$(ECHO_BLANK)
...
ifeq ($(wildcard $(ENV_FILE)),)
	...
	@$(COPY) .env.example $(ENV_FILE) >$(NULL_DEVICE) 2>&1
else
