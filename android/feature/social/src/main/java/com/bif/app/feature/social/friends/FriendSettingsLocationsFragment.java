...
public class FriendSettingsLocationsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_friend_settings_locations, container, false);
    }
    ...
    private void setupTabs(TabLayout tabLayout, int selectedPosition, View rootView) {
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                android.net.Uri uri = UriUtils.buildUri(UriUtils.PathTo.FRIEND_SETTINGS_TRIPS)
                        .buildUpon()
