...
@AndroidEntryPoint
public class GroupSettingsPlansFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_group_settings_plans, container, false);
    }
    ...
    private void setupTabs(TabLayout tabLayout, int selectedPosition, View rootView) {
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                UriUtils.PathTo dest = position == 1
